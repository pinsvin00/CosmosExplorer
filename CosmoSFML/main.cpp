...
int main()
{
	//kocham cie paprochu : D
	/*
	zla nawigacja po systemie gwiezdnym
	jesli bedzie dobra nawgiacja zrob dokladniejsza fizyke silnika
	oraz moze bardziej dokladne podroze
	*/
    ...
    menu_options.push_back(sf::Text("Kocham cie Olgusia : >", font, 50));
